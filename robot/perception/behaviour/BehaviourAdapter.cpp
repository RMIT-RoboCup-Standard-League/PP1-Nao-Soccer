         ...
         safetySkill(bb->behaviour.useGetups)
{
   ...
   startupSpeech << noHearWhistles << std::string("Player ") << BehaviourHelpers::playerNumber(blackboard) <<
      ...
      " I am " << hostname;
   // Note there is a max length of string the robot will say which overflows
   // if noHearWhistles is present (i.e. the robot won't say their name).
   // A string which works is "I can not hear whistles. Player 3" of length 33.
