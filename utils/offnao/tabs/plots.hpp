...
class AngleXPlot : public DataPlot {
   Q_OBJECT

   public:
      AngleXPlot(QWidget* = NULL);
      virtual void push(SensorValues sensors, bool left=false);
   private:
...
class GyroXPlot : public DataPlot {
   Q_OBJECT

   public:
      GyroXPlot(QWidget* = NULL);
      virtual void push(SensorValues sensors, bool left=false);
   private:
      double data[PLOT_SIZE];
      double data2[PLOT_SIZE];
};
class GyroYPlot : public DataPlot {
   Q_OBJECT

   public:
      GyroYPlot(QWidget* = NULL);
      virtual void push(SensorValues sensors, bool left=false);
   private:
      double data[PLOT_SIZE];
      double data2[PLOT_SIZE];
