...
i = -1
log_folder_path = '/var/volatile/runswift/%s' % log_folders[i]

# Make sure we get a folder and not a file
while(os.path.isfile(log_folder_path)):
	i =- 1	
	log_folder_path = '/var/volatile/runswift/%s' % log_folders[i]
	
log_folder = '%s/behaviour' % log_folder_path 
