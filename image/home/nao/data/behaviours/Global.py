...
def amILost():
    ...
    # Magical constants from a quick run with Freya, could tune these better
    # NOTE: Initially localisation sets these as:
    #    ('robotPosUncertainty', 1185868.75)
    # ('robotHeadingUncertainty', 0.3926990948947125)
    # They seem to fluctuate between around 10**5 and 5 * 10**6,
    # and 0.1 to 2.5 or so respectively.
